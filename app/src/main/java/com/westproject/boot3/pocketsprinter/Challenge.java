...
import com.westproject.boot3.pocketsprinter.R;
...
public class Challenge {
        ...
        public String toString(Context ctx) {
            ...
            switch (this) {
                ...
                case JOG:
                    ...
                    break;
                default:
                    throw new IllegalStateException("Segment type is not valid");
            }
    ...
    private static Challenge c25kWorkouts;

    public static synchronized Challenge loadC25kWorkouts(Context ctx) {
        ...
        return c25kWorkouts = new Challenge(workouts);
    }
