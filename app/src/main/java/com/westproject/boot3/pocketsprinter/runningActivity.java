...
public class runningActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
            ...
            public void uncaughtException(Thread thread, Throwable e) {
                startActivity(new Intent(Intent.ACTION_SEND)
                        ...
                        .putExtra(Intent.EXTRA_SUBJECT, "Jogging runningTimer crash log")
        ...
        currentWorkoutSet = Challenge.loadC25kWorkouts(this);
    ...
    public void nextWorkout(View view) {
        if (BuildConfig.DEBUG && workoutIdx >= currentWorkoutSet.length() - 1) {
    ...
    public void prevWorkout(View view) {
        if (BuildConfig.DEBUG && workoutIdx < 1) {
            throw new AssertionError();
        }
        cancelVibrations();
        --workoutIdx;
    ...
    private runningTimer makeTimer() {
        return new runningTimer(currentWorkoutSet.get(workoutIdx).getSegment(segmentIdx).length(), 50) {
            @Override
    ...
    private void setUpProgressBarsForCurrentSegment() {
        Challenge.Segment currentSegment = currentWorkoutSet.get(workoutIdx).getSegment(segmentIdx);
        currentAction.setText(currentSegment.getType().toString(runningActivity.this));
